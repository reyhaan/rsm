function findCommunityAvg(A)
%findCommunityAvg Summary of this function follows here
%   Detailed explanation goes here
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

dtType = [datestr(datetime('now','Format','y_MMM_d_HH:mm:ss')) '_Avg'];
...
CS = getCommunities(RM,mean(RM(:))); % CS is the set of the communities
